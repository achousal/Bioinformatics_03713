...
HUMAN_LIVER_PEAKS_GZ="$BASE_DIR/ikaplow/HumanAtac/Liver/peak/idr_reproducibility/idr.optimal_peak.narrowPeak.gz"
HUMAN_PANCREAS_PEAKS_GZ="$BASE_DIR/ikaplow/HumanAtac/Pancreas/peak/idr_reproducibility/idr.optimal_peak.narrowPeak.gz"
MOUSE_LIVER_PEAKS_GZ="$BASE_DIR/ikaplow/MouseAtac/Liver/peak/idr_reproducibility/idr.optimal_peak.narrowPeak.gz"
MOUSE_PANCREAS_PEAKS_GZ="$BASE_DIR/ikaplow/MouseAtac/Pancreas/peak/idr_reproducibility/idr.optimal_peak.narrowPeak.gz"

# Genome FASTA files
HUMAN_GENOME_FA="$BASE_DIR/ikaplow/HumanGenomeInfo/hg38.fa"
MOUSE_GENOME_FA="$BASE_DIR/ikaplow/MouseGenomeInfo/mm10.fa"
